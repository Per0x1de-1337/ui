...
var TotalK8sClientRequests = prometheus.NewCounterVec(
...
var K8sClientRequestDuration = prometheus.NewHistogramVec(
...
var K8sClientErrorCounter = prometheus.NewCounterVec(
	prometheus.CounterOpts{
